...
Este repositório contém a solução para o desafio de [Front-end da Smart Fit](https://github.com/bioritmo/front-end-code-challenge-smartsite/tree/master) desenvolvido com a intenção de melhorar minhas habilidades com angular.

## 💻 veja em produção!
- Veja (https://desafio-smart-fit-kohl.vercel.app)
## 📖 Sobre o desafio
...
```bash
  git clone https://github.com/devbastos/Desafio_smartFit.git
